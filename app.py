...
LOCATIONS = [
    "ห้องนักกายCN", "ห้องแต่งปูนCN", "ห้องเครื่องจักรCN",
    "ห้องขึ้นรูปขาเทียมCN", "ห้องช่างรวมCN", "ห้องเครื่องจักร รร", "ห้องขึ้นรูปขาเทียม รร", "ห้องแต่งปูน รร",
    "ห้องเครื่องจักร รร", "ห้องเครื่องจักรCEPO", "ห้องแต่งปูนCEPO", "อื่นๆ"
]
